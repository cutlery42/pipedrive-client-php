 ...
 */
class Data21 implements JsonSerializable
{
    /**
     * The ID of the Deal
     ...
     * @maps average_time_to_won
     * @var \Pipedrive\Models\AverageTimeToWon|null $averageTimeToWon public property
     */
    public $averageTimeToWon;

    /**
     * The average of the Deal stage progression
     * @maps average_stage_progress
     * @var double|null $averageStageProgress public property
     */
    public $averageStageProgress;

    /**
     * The lifetime of the Deal
     * @var \Pipedrive\Models\Age|null $age public property
     */
    public $age;

    /**
     * The details of the duration of the Deal being in each stage of the pipeline
     * @maps stay_in_pipeline_stages
     * @var \Pipedrive\Models\StayInPipelineStages|null $stayInPipelineStages public property
     */
    public $stayInPipelineStages;

    /**
     * The details of the last activity associated with the Deal
     * @maps last_activity
     * @var object|null $lastActivity public property
     */
    public $lastActivity;
     ...
     * @maps next_activity
     * @var object|null $nextActivity public property
     */
    public $nextActivity;
     ...
     * @param AverageTimeToWon     $averageTimeToWon         Initialization value for $this->averageTimeToWon
     * @param double               $averageStageProgress     Initialization value for $this->averageStageProgress
     * @param Age                  $age                      Initialization value for $this->age
     * @param StayInPipelineStages $stayInPipelineStages     Initialization value for $this->stayInPipelineStages
     * @param object               $lastActivity             Initialization value for $this->lastActivity
     * @param object               $nextActivity             Initialization value for $this->nextActivity
     */
    public function __construct()
    {
        if (64 == func_num_args()) {
            ...
            $this->averageTimeToWon         = func_get_arg(58);
            $this->averageStageProgress     = func_get_arg(59);
            $this->age                      = func_get_arg(60);
            $this->stayInPipelineStages     = func_get_arg(61);
            $this->lastActivity             = func_get_arg(62);
            $this->nextActivity             = func_get_arg(63);
        }
    }
    ...
    public function jsonSerialize(): mixed
    {
        ...
        $json['average_time_to_won']        = $this->averageTimeToWon;
        $json['average_stage_progress']     = $this->averageStageProgress;
        $json['age']                        = $this->age;
        $json['stay_in_pipeline_stages']    = $this->stayInPipelineStages;
        $json['last_activity']              = $this->lastActivity;
        $json['next_activity']              = $this->nextActivity;
