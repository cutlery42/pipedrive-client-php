 ...
 */
class BasicGoal implements JsonSerializable
{
    /**
     * Title of the goal.
     ...
     * or team.
     * @var object|null $assignee public property
     */
    public $assignee;
     ...
     * @var object|null $type public property
     */
    public $type;
     ...
     * @var object|null $expectedOutcome public property
     */
     ...
     * @var object|null $duration public property
     */
    public $duration;
     ...
     * Date when the goal starts and ends. It requires the following JSON structure: { "start": "2019-01-
     * 01", "end": "2022-12-31" }. Date in format of YYYY-MM-DD.
     * @var string|null $interval public property
     */
    public $interval;
