 ...
 */
class BaseDeal implements JsonSerializable
{
    /**
    ...
    {
        if (53 == func_num_args()) {
            $this->stageId                  = func_get_arg(0);
            $this->title                    = func_get_arg(1);
            $this->value                    = func_get_arg(2);
            $this->currency                 = func_get_arg(3);
            $this->addTime                  = func_get_arg(4);
            $this->updateTime               = func_get_arg(5);
            $this->stageChangeTime          = func_get_arg(6);
            $this->active                   = func_get_arg(7);
            $this->deleted                  = func_get_arg(8);
            $this->status                   = func_get_arg(9);
            $this->probability              = func_get_arg(10);
            $this->nextActivityDate         = func_get_arg(11);
            $this->nextActivityTime         = func_get_arg(12);
            $this->nextActivityId           = func_get_arg(13);
            $this->lastActivityId           = func_get_arg(14);
            $this->lastActivityDate         = func_get_arg(15);
            $this->lostReason               = func_get_arg(16);
            $this->visibleTo                = func_get_arg(17);
            $this->closeTime                = func_get_arg(18);
            $this->pipelineId               = func_get_arg(19);
            $this->wonTime                  = func_get_arg(20);
            $this->firstWonTime             = func_get_arg(21);
            $this->lostTime                 = func_get_arg(22);
            $this->productsCount            = func_get_arg(23);
            $this->filesCount               = func_get_arg(24);
            $this->notesCount               = func_get_arg(25);
            $this->followersCount           = func_get_arg(26);
            $this->emailMessagesCount       = func_get_arg(27);
            $this->activitiesCount          = func_get_arg(28);
            $this->doneActivitiesCount      = func_get_arg(29);
            $this->undoneActivitiesCount    = func_get_arg(30);
            $this->referenceActivitiesCount = func_get_arg(31);
            $this->participantsCount        = func_get_arg(32);
            $this->expectedCloseDate        = func_get_arg(33);
            $this->lastIncomingMailTime     = func_get_arg(34);
            $this->lastOutgoingMailTime     = func_get_arg(35);
            $this->label                    = func_get_arg(36);
            $this->stageOrderNr             = func_get_arg(37);
            $this->personName               = func_get_arg(38);
            $this->orgName                  = func_get_arg(39);
            $this->nextActivitySubject      = func_get_arg(40);
            $this->nextActivityType         = func_get_arg(41);
            $this->nextActivityDuration     = func_get_arg(42);
            $this->nextActivityNote         = func_get_arg(43);
            $this->formattedValue           = func_get_arg(44);
            $this->weightedValue            = func_get_arg(45);
            $this->formattedWeightedValue   = func_get_arg(46);
            $this->weightedValueCurrency    = func_get_arg(47);
            $this->rottenTime               = func_get_arg(48);
            $this->ownerName                = func_get_arg(49);
            $this->ccEmail                  = func_get_arg(50);
            $this->orgHidden                = func_get_arg(51);
            $this->personHidden             = func_get_arg(52);
        }
    }
