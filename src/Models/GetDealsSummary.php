 ...
 */
class GetDealsSummary implements JsonSerializable
{
    /**
     ...
     * @var \Pipedrive\Models\Data24|null $data public property
     */
    public $data;
     ...
     * @param Data24 $data    Initialization value for $this->data
     */
